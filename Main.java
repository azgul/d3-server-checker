...
public class Main {
	...
	private static ArrayList<String> getBadIPs() {
		if (bad == null) {
			...
			bad.add("80.239.209.17");
			bad.add("80.239.209.19");
			bad.add("80.239.209.20");
			...
			bad.add("80.239.209.73");
			bad.add("80.239.209.74");
			
			// 80.239.210.x
			bad.add("80.239.210.91");
			bad.add("80.239.210.92");
			...
			bad.add("80.239.210.176");
			bad.add("80.239.210.177");
			bad.add("80.239.210.178");
			bad.add("80.239.210.179");
			bad.add("80.239.210.182");
			bad.add("80.239.210.183");
			...
			bad.add("80.239.211.34");
			bad.add("80.239.211.35");
